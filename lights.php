...
<body>
  ...
  <div id="wrapper" class="hidden">
    ...
    <nav class="navbar navbar-expand fixed-top d-flex flex-row justify-content-start">
      ...
      <a class="navbar-brand px-lg-3 px-1 mr-0" href="lights.php#">SMART family</a>
      <div class="ml-auto">
      ...
      <div class="row-offcanvas row-offcanvas-left">
        ...
        <div id="sidebar" class="sidebar-offcanvas">
          <ul class="nav flex-column nav-sidebar">
            ...
            <li class="nav-item">
              <a class="nav-link disabled" href="lights.php#">
                <svg class="icon-sprite">
                ...
                <div class="card active" data-unit="switch-light-1">
                  ...
                  <div class="info-holder info-cb">
                    <div data-toggle="popover-all"
                      ...
                      data-original-title="Dimmer control" data-placement="top" data-offset="0,-24"></div>
                  </div>
