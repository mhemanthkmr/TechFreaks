...
<head>
  ...
  <title>SYMBIOT4 Cameras - Bootstrap 4 theme</title>
...
<body>
  ...
  <div id="wrapper" class="hidden">
    ...
    <nav class="navbar navbar-expand fixed-top d-flex flex-row justify-content-start">
      ...
      <a class="navbar-brand px-lg-3 px-1 mr-0" href="cameras.php#">SMART family</a>
      <div class="ml-auto">
      ...
      <div class="row-offcanvas row-offcanvas-left">
        ...
        <div id="sidebar" class="sidebar-offcanvas">
          <ul class="nav flex-column nav-sidebar">
            ...
            <li class="nav-item">
              <a class="nav-link disabled" href="cameras.php#">
                <svg class="icon-sprite">
                  ...
                  <ul class="list-group borderless px-1">
                    ...
                    <li class="list-group-item flex-column py-2">
                      ...
                      <div class="info-holder info-ct">
                        <div data-toggle="popover-all" data-content="Group of radio buttons."
                          data-original-title="Option settings" data-placement="bottom" data-offset="0,-32"></div>
                      </div>
                    </li>
